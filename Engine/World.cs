...
namespace Engine
{
    public static class World
    {
        ...
        public const int ITEM_ID_SNAKE_SKIN = 4;
        ...
        public const int LOCATION_ID_SPIDER_FIELD = 5;
        public const int LOCATION_ID_ALCHEMIST_HUT = 6;
        public const int LOCATION_ID_ALCHEMISTS_GARDEN = 7;
        public const int LOCATION_ID_FARMHOUSE = 8;
        ...
        {
            Monster rat = new Monster(MONSTER_ID_RAT, "Rat", 5, 3, 10, 3, 3, 10);
            rat.LootTable.Add(new LootItem(ItemByID(ITEM_ID_RAT_TAIL), 75, false));
            rat.LootTable.Add(new LootItem(ItemByID(ITEM_ID_PIECE_OF_FUR), 75, true));

            Monster snake = new Monster(MONSTER_ID_SNAKE, "Snake", 5, 3, 10, 3, 3, 15);
